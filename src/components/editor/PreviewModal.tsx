      ...
      <DialogContent className="max-w-6xl h-[90vh] flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 overflow-auto bg-muted/50 p-4">
          ...
          >
            ...
            <article className="p-6 md:p-8">
              ...
              {/* 本文 */}
              <div
                className="prose prose-lg dark:prose-invert max-w-none preview-content"
                dangerouslySetInnerHTML={{
                  __html: content || "<p class='text-muted-foreground'>本文が入力されていません</p>",
                }}
              />
            </article>
          </div>
        ...
        <div className="px-4 py-3 border-t flex-shrink-0 flex items-center justify-between text-sm text-muted-foreground">
          <span>
            ...
            {device === "tablet" && "タブレット表示 (768px)"}
            {device === "mobile" && "モバイル表示 (375px)"}
          </span>
